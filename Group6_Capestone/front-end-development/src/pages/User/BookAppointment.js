            ...
            <form style={formStyle} onSubmit={handleAppointmentBooking}>
              ...
              <div style={divStyle}>
                ...
                >
                 ...
                 {dateData?.availableDates.map((appointment) => (
              ...
              <div style={divStyle}>
                ...
                >
                  ...
                  {timeData?.availableTimes.map((appointment) => (
                    <option key={appointment.appointmentTime} value={appointment.appointmentTime}>
